(function(){
  ...
  var E={}, last={}, vw, vh, span, wmW, wmH, pw, t, prev, settled;
  ...
  function apply(){
    ...
    E.track.style.height = props.scrollLength*100 + 'vh';
  }
  function measure(){
  ...
  function write(t){
    ...
    var bw=mix(620/props.startZoom,620,z), bh=bw*(vh/vw);
    var cx=mix(46,110.4,z)+drift*46, cy=mix(176,98,z)-drift*40;
    ...
    var fsMax=Math.min(vw*0.052,(vw*0.86)/(pw/100),84);
